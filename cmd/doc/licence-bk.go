...
func init() {
	...
	_cdbec = &LicenseKey{
	LicenseId:"itisokey@foxmail.com",
	CustomerId:"1234567890",
	CustomerName:"itisokey",
	Tier:LicenseTierBusiness,
	CreatedAt:_fe.Now(),
	CreatedAtInt:_fe.Now().Unix(),
	ExpiresAt:_fe.Now().Add(365*24*_fe.Hour),
	ExpiresAtInt: _fe.Now().Add(365*24*_fe.Hour).Unix(),
	CreatedBy:"itisokey",
	CreatorEmail:"itisokey@foxmail.com",
	UniPDF:true,
	UniOffice:true,
	UniHTML:true,
	Trial:false,
...
func GetMeteredState() (MeteredStatus, error) {
	...
	// }
	_cag := MeteredStatus{OK: true, Credits: 1024, Used: 1024}
	return _cag, nil
}
